...
def _normalize(text: str) -> str:
    """Chuẩn hóa text: bỏ dấu tiếng Việt, lowercase, chỉ giữ chữ và số."""
...
class OrderDataStore:
    def __init__(self, data_dir: Path, output_dir: Path, *, today: str | None = None) -> None:
        ...
        # Vietnamese / English category aliases → canonical category name
    ...
    def build_detail_token(product_ids: list[str]) -> str:
        """Tạo token xác thực cho một tập product ID (deterministic)."""
    ...
    def list_products(
        ...
        *,
        ...
        """Tìm kiếm sản phẩm trong catalog theo query, category, giá, tags."""
                ...
                (
                    ...
                    product.product_id,
                    {
                        ...
                        "next_step": (
                            ...
                            "to verify price, stock, and the detail_token."
                        ),
                    },
                )
            )
    ...
    def get_product_details(self, product_ids: list[str]) -> dict:
        """Trả về thông tin chi tiết (giá, tồn kho, warranty) và detail_token."""
        details: list[dict] = []
    ...
    def get_discount(self, *, seed_hint: str, customer_tier: str = "standard") -> dict:
        """Tính discount rate (0.1 hoặc 0.2) theo seed deterministic."""
    ...
    def calculate_order_totals(
        ...
        *,
        ...
        """Kiểm tra tồn kho và tính tổng tiền sau giảm giá."""
    ...
    def save_order(
        ...
        *,
        ...
        """Tính lại tổng tiền, tạo order ID deterministic, lưu JSON ra disk."""
        # Recompute totals để đảm bảo dữ liệu nhất quán
        ...
        # Tạo order ID deterministic từ email + phone + items
        ...
        # Use forward slashes for cross-platform compatibility (grader expects artifacts/orders/...)
